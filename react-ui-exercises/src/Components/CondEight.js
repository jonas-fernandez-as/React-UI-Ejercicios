...
const CondEight = () => {
  ...
  const minor = (num1, num2, num3, num4) => {
    let n1 = parseInt(num1);
    let n2 = parseInt(num2);
    let n3 = parseInt(num3);
    let n4 = parseInt(num4);
    if (n1 < n2 && n1 < n3 && n1 < n4) setRes(`Minor: "${n1}"`);
    if (n2 < n1 && n2 < n3 && n2 < n4) setRes(`Minor: "${n2}"`);
    if (n3 < n2 && n3 < n1 && n3 < n4) setRes(`Minor: "${n3}"`);
    if (n4 < n1 && n4 < n3 && n4 < n2) setRes(`Minor: "${n4}"`);
  };

  const handleSubmit = (e) => {
    e.preventDefault();
    minor(form.number1, form.number2, form.number3, form.number4);
  };
